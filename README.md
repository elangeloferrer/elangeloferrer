...
- **[Task Management System](https://github.com/elangeloferrer/task-management-system)** — User and admin roles, real-time analytics, and automated cleanup with queued jobs. Laravel, Laravel Reverb, Vue, TypeScript, MySQL.
